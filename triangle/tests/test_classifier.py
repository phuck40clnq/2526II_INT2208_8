...
def test_triangle_inequality_violated_returns_not_triangle(case):
...
def test_all_sides_equal_returns_equilateral(case):
...
def test_two_sides_equal_returns_isosceles(case):
...
def test_all_sides_different_returns_scalene(case):
